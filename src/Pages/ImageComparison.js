    ...
    return (
        <>
            ...
            <div className="gallery">
                <img ref={idCardRef} src={require('../Assets/images/user-1.png')} alt="ID card" height="auto" />
            </div>

            <div className="gallery">
                <img ref={selfieRef} src={require('../Assets/images/user-1.png')} alt="Selfie" height="auto" />
            </div>
        </>
    );
};
